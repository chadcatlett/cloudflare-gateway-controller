module github.com/matheuscscp/cloudflare-gateway-controller
...
// latest release.
replace github.com/cloudflare/cloudflared => github.com/matheuscscp/cloudflared v0.0.0-20260727090130-66c0a54732b5
